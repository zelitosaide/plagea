  ...
  const fetchSampleById = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Check if the sample type is a custom one (not in the predefined list)
      ...
      <div className="container mx-auto p-6">
        <div className="mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">Editar Amostra</h1>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Atualizar detalhes da amostra</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="relative space-y-2">
                  ...
                  >
                    ...
                    {formData.entryDate
                      ? formatDate(new Date(formData.entryDate))
                      : "Selecione uma data"}
                  </Button>
                  {showEntryCalendar &&
                ...
                <div className="relative space-y-2">
                  ...
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {formData.expiryDate
                      ? formatDate(new Date(formData.expiryDate))
                      : "Selecione uma data"}
                  </Button>
                  {showExpiryCalendar &&
                    generateCalendar(
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Atualize o local de armazenamento
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
